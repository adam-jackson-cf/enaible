---
description: Plan initial project structure, tooling, and quality bar
---
...
- `opencode /create-project [project-name] [technologies]`
- `opencode /create-project [project-name] --from-todos [todos-file-path]`
...
- `opencode /create-project my-app react-native-nativewind hono postgresql`
- `opencode /create-project dashboard --from-todos ./todos/todos.md`
- `opencode /create-project api-service elysia bun sqlite drizzle`
