...
- @TARGET_PATH = ${input:target-path} — repository root for discovery (default .)

### Derived (internal)

- @COMPONENTS_JSON — JSON array describing services ({ name, label, cwd, start_command, port|null })
...
8. Update AGENTS.md (direct content)
