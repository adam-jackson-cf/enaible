...
- @USER_PROMPT = ${input:user-prompt} — description of the technical problem to solve

### Optional (derived from $ARGUMENTS)

- @AUTO = ${input:auto} — skip STOP confirmations (auto-approve checkpoints)
- @TARGET_PATH = ${input:target-path} — repository path when targeting an existing codebase (default .)
