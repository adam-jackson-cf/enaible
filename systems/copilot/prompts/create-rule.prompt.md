...
- @TECHNOLOGY = ${input:technology} — technology or framework to document

### Optional (derived from $ARGUMENTS)

- @AUTO = ${input:auto} — skip STOP confirmations (auto-approve checkpoints)
- @RULE_FILE_PATH = ${input:out} — destination path for the generated implementation rule (defaults to `rules/<slug>.md`)
