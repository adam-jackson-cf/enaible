...
- @INSTALL_DIR = ${input:install-dir} — installation directory (default ~/.local/bin)

### Derived (internal)

- @REPO_URL — browser-tools repository URL (https://github.com/badlogic/agent-tools)
...
- Document commands in AGENTS.md for reference (project or user level).
...
4. (Optional) Add shell aliases from AGENTS.md for shorter commands
```
