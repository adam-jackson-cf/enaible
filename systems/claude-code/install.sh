...
EOF
        ...
        # Ensure jscpd is present if package.json already exists
...
# Verify jscpd availability (global via npx or locally installed in the ESLint workspace)
check_jscpd() {
...
copy_files() {
    ...
    # Resolve shared/ at repo root: systems/claude-code -> systems -> repo
