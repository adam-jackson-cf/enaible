---
description: Apply a named rule set to guide implementation and reviews
---
...
2. **Resolve RULE_FILE_PATH using hierarchical search**:
   ...
   **FIRST - Try project-level .opencode/rules folder**:

   ```bash
   Glob: ".opencode/rules/[ARGUMENTS].rules.md"
   ```
