---
description: Create a new OpenCode command for a repeated workflow
---
...
- For "project" scope: Create the command file in `.opencode/commands/[command-name].md`
- For "user" scope: Create the command file in `$HOME/.opencode/command/[command-name].md`
