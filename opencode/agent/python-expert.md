---
description: Plans and reviews Python implementations; emphasizes correctness, typing, and tests
mode: subagent
permission:
  edit: deny
  bash: ask
...
- Analyze existing Python codebases using `OpenCode LSP/search`
