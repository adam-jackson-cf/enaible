---
description: Validates technical approach before implementation; ensures feasibility and standards compliance
mode: subagent
permission:
  edit: deny
  bash: ask
...
2. Invoke `OpenCode LSP/search` for comprehensive codebase search and analysis
