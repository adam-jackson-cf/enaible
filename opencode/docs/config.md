...
- [ Install ](https://opencode.ai/docs/config/#install)
- [ Configure ](https://opencode.ai/docs/config/#configure)
- [ Initialize ](https://opencode.ai/docs/config/#initialize)
- [ Usage ](https://opencode.ai/docs/config/#usage)
  - [ Ask questions ](https://opencode.ai/docs/config/#ask-questions)
  - [ Add features ](https://opencode.ai/docs/config/#add-features)
  - [ Make changes ](https://opencode.ai/docs/config/#make-changes)
  - [ Undo changes ](https://opencode.ai/docs/config/#undo-changes)
- [ Share ](https://opencode.ai/docs/config/#share)
- [ Customize ](https://opencode.ai/docs/config/#customize)
...
#### [Prerequisites](https://opencode.ai/docs/config/#prerequisites)
...
You can also install it with the following:
  * **Using Node.js**
    * [ npm ](https://opencode.ai/docs/config/#tab-panel-0)
    * [ Bun ](https://opencode.ai/docs/config/#tab-panel-1)
    * [ pnpm ](https://opencode.ai/docs/config/#tab-panel-2)
    * [ Yarn ](https://opencode.ai/docs/config/#tab-panel-3)
Terminal window```
...
#### [Windows](https://opencode.ai/docs/config/#windows)
