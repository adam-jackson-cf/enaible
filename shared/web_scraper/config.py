...
class CrawlAIMCPConfig:
    ...
    relevance_thresholds: RelevanceThresholds = field(
        default_factory=RelevanceThresholds
    )
    ...
    def _apply_development_config(self):
        ...
        self.budget_allocation.default_time_budget_seconds = (
            600  # More time for development
        )
    ...
    def _apply_testing_config(self):
        ...
        self.cache_settings.enable_relevance_cache = (
            False  # Disable caching for consistent tests
        )
    ...
    def get_token_limit_for_operation(
        self, operation: str, operation_type: str = "input"
    ) -> int:
        ...
        return operation_map.get(operation, {}).get(
            operation_type, 1000
        )  # Default fallback
...
_config_instance: CrawlAIMCPConfig | None = None
