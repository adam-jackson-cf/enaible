...
|        | 2       | 6      | Read      | Inspect `docs/system/claude-code/templates/command.md.j2:1`, `docs/system/codex/templates/prompt.md.j2:1`, and `docs/system/opencode/templates/command.md.j2:1` to confirm frontmatter + managed sentinel placement.                                                         |
...
|        | 3       | 12     | Action    | Render pilots end-to-end: `uv run --project tools/enaible enaible prompts render --prompt analyze-security,get-codebase-primer --system claude-code,opencode,codex,copilot -o systems` then commit regenerated files with `<!-- generated: enaible -->`.                     |
