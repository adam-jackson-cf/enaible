...
TESTING=true PYTHONPATH=. python shared/ci/integration/orchestration_bridge.py \
  --project-root shared/tests/fixture/test_codebase/duplicate_detectors \
...
bridge = OrchestrationBridge('shared/tests/fixture/test_codebase/duplicate_detectors', test_mode=True, config_path='shared/tests/integration/ci_config_test.json')
...
- Excludes main project directories, focuses only on `shared/tests/fixture/test_codebase/duplicate_detectors`
...
```
shared/tests/fixture/test_codebase/duplicate_detectors/
...
ls -la shared/tests/fixture/test_codebase/duplicate_detectors/
